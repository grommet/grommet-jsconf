...
const ChartThree = () => {
  return (
    <svg className="chart__graphic" viewBox="0 0 558 192"
      preserveAspectRatio="none" tabIndex="0" role="application"
      ...
      <g className="chart__values">
        <g role='img' aria-label='May 22: First: 5, Second: 5.'>
        ...
        <g role='img' aria-label='May 21: First: 5, Second: 0.'>
        ...
        <g role='img' aria-label='May 20: First: 3, Second: 2.'>
        ...
        <g role='img' aria-label='May 19: First: 6, Second: 0.'>
...
ChartThree.displayName = 'ChartThree';
